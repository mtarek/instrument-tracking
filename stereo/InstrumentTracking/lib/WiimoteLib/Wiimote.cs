...
namespace WiimoteLib
{
	...
	public class Wiimote : IDisposable
	{
        ...
        // Device index in the HID list (same as index passed to Connect())
        ...
        /// <summary>
		/// Connects to the first available Wiimote paired to the PC via Bluetooth
		/// </summary>
		public void Connect()
        {
            Connect(1);
        ...
        /// <param name="number">1 for first device, 2 for second .. etc. 
        /// Connection is successful only if a device is found at the specific order</param>
		/// </summary>
